...
// backend data_config API. This config object defines in an group of
// time-series's with a list of instances.
...
export class FieldData {
  ...
  //         group of time-series's, with a list of instances
  ...
  updateBuffer() {
    ...
    // get the data link
    var link = new DataLink.MetricStreamLink($SCRIPT_ROOT + this.stream_link, this.stream, this.config.group, this.config.instances, [this.metric]);
    // get the data poll
