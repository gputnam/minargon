...
//                   time-series corresponding to a list of fields for a
//                   single instance
...
//                              single field in a single instance. 
...
class TimeSeries {
  ...
  // stream_links: A list of base-links for the different streams for
  //               each time-series
  // streams: A list of names for the different streams for each
  // time-series
  // href: (optional) function which will be passed the data_config instance and
  //        field corresponding to the clicked time-series and should 
  ...
  //              time-series list
  // field_list: The list of fields to be queried in the time-series
  //             list
  // NOTE: The final list of time-series will be a product of the
  // metric_list and the field_list. I.e. if len(metric_list) = 3 and
  // len(field_list) = 5 then there will be 15 total time-series
  // generated
...
export class CubismMultiMetricController {
  ...
  // timeseries_config: DataConfig object generated by the data_config backend and
  //                    encoded as a JSON dictionary. Should correspond to a single
  //                    instance of time-series's, with a list of fields
  // stream_links: A list of base-links for the different streams for
  //               each time-series
  // streams: A list of names for the different streams for each
  // field_index: The index into the list of fields in
  //              "timeseries_config" corresponding to the field we
...
export class CubismController {
  ...
  // strip chart
  // Fhref: function which will be passed the data_config instance and
  //        field corresponding to the clicked time-series and should 
